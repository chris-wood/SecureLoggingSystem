...
%Common vulnerabilities like SQL injections and buffer overflows can
%be detected by examining source code, and if the dynamic analysis tools fail to reveal any such vulnerabilities, 
%this manual examination will hopefully yield better results.
